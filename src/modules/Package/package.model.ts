...
import { Activity, IPackage, Price, TReview } from "./package.interface";
...
/** Activity Included Schema */
export const ActivityIncludedSchema = new Schema(
  {
    name: { type: String, required: true },
    amount: { type: PriceSchema, required: true }, // nested price sub-doc
